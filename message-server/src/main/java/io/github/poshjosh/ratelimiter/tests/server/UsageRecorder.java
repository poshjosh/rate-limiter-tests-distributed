...
public class UsageRecorder {
    ...
    public void collect() {
        synchronized (mutex) {
            ...
            long averageMemoryPerRequest = (usedMemoryPerInterval / requestsPerInterval) / ONE_MILLION;
            usage.add(Usage.of(requestsPerInterval / INTERVAL_SECONDS, Math.max(averageMemoryPerRequest, 0)));
